...
public class TsscGame implements Serializable {
	...
	@NotBlank(groups=ValidatedGame.class, message = "No se puede dejar la password vacia")
	...
	@Min(value=1, groups=ValidatedGame.class, message = "La cantidad de Groups debe ser mayor a 0")
	private Integer nGroups = 4;

	@Column(name = "N_SPRINTS")
	@Min(value=1, groups=ValidatedGame.class, message = "La cantidad de Sprints debe ser mayor a 0")
	private Integer nSprints = 4;

	@NotBlank(groups=ValidatedGame.class, message = "No se puede dejar el nombre vacio")
	private String name;
	...
	@NotNull(groups=ValidatedGame.class, message = "No se puede dejar la fecha vacia")
	@DateTimeFormat(pattern = "yyyy-MM-dd")
	private LocalDate scheduledDate;

	@Column(name = "SCHEDULED_TIME")
	@DateTimeFormat(iso = ISO.TIME)
	@NotNull(groups=ValidatedGame.class, message = "Debes elegir una hora")
