...
public class TsscTopic implements Serializable {
	...
	@NotBlank(groups=ValidatedTopic.class, message = "No se puede dejar la descripción vacia")
	private String description;
	
	@NotBlank(groups=ValidatedTopic.class, message = "No se puede dejar el nombre vacio")
	private String name;

	@Min(value = 1, groups=ValidatedTopic.class, message = "La cantidad de Sprint debe ser mayor a 0")
	@Column(name = "DEFAULT_SPRINTS")
	private long defaultSprints;

	@Min(value = 1, groups=ValidatedTopic.class, message = "La cantidad de Grops debe ser mayor a 0")
	@Column(name = "DEFAULT_GROUPS")
	private long defaultGroups;

	@NotBlank(groups=ValidatedTopic.class, message = "No se puede dejar el prefijo del grupo vacio")
